...
drop trigger tg_check_after_insert_enroll; 
drop trigger tg_check_after_delete_enroll;
drop trigger tg_check_before_delete_student;
drop trigger tg_log_after_delete_student;
drop trigger tg_log_after_insert_enrollment;
drop trigger tg_log_after_delete_enrollment;
